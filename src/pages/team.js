    ...
    <>
      ...
      <div className="axil-our-team section-gap">
        <div className="container">
          <p className="m-b-xs-30 big">
            Meet the amazing people who make TBM possible through their energy,
            experience, <br />
      ...
      <div className="join-us section-gap-bottom">
        <div className="container">
          <SectionTitleTwo
            title="We Are Hiring"
            paragraph="We are always looking for the right people to join our passionate team of dedicated people. To
                    supportTEC growth,<br /> we welcome highly motivated people."
            tSpace="m-b-xs-30"
          />
          <div className="row">
            <div className="col-lg-10 offset-lg-1">
              <div className="axil-avaiable-positions p-t-xs-10">
                <div className="axil-position-block">
                  ...
                  <a href="#" className="btn btn-primary btn-nofill btn-small">
                    APPLY HERE
                  </a>
                </div>
                <div className="axil-position-block">
                  <h3 className="axil-position-title">
